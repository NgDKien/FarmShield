            ...
            {isSidebarOpen && (
                <div className="px-4 pt-6">
                    ...
                    <div className="flex flex-col mt-8 lg:mt-12 space-y-3">
                        <div className="flex items-center p-2 lg:p-3 transition-all duration-200 hover:bg-blue-50 cursor-pointer group relative overflow-hidden rounded-lg">
                        ...
                        <div className="flex items-center p-2 lg:p-3 transition-all duration-200 hover:bg-red-50 cursor-pointer group relative overflow-hidden rounded-lg">
